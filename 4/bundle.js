...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _mock_generate_trip_event_item__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mock/generate-trip-event-item */ "./src/mock/generate-trip-event-item.js");
...
/* harmony import */ var _view_layout_content__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view/layout/content */ "./src/view/layout/content.js");
...
const generateTripEvents = () => {
  const eventsAmount = Object(_utils__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(MIN_EVENTS_AMOUNT, MAX_EVENTS_AMOUNT);
  const tripEvents = new Array(eventsAmount).fill().map(_mock_generate_trip_event_item__WEBPACK_IMPORTED_MODULE_0__["generateTripEventItem"]);
...
render(aboutTripContainer, Object(_view_layout_trip_info__WEBPACK_IMPORTED_MODULE_2__["getTripInfoMarkup"])(tripInfo), `afterbegin`);
clearInnerHTML(menuContainer);
render(menuContainer, Object(_view_layout_menu__WEBPACK_IMPORTED_MODULE_3__["getMenuMarkup"])(), `afterbegin`);
render(menuContainer, Object(_view_layout_filters__WEBPACK_IMPORTED_MODULE_4__["getFiltersMarkup"])(), `beforeend`);
clearInnerHTML(tripEventsContainer);
render(tripEventsContainer, Object(_view_layout_sort__WEBPACK_IMPORTED_MODULE_5__["getSortMarkup"])(), `afterbegin`);
render(tripEventsContainer, Object(_view_layout_content__WEBPACK_IMPORTED_MODULE_6__["getContentMarkup"])(tripEvents), `beforeend`);
...
/***/ "./src/view/layout/content.js":
/*!************************************!*\
  !*** ./src/view/layout/content.js ***!
  \************************************/
/*! exports provided: getContentMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getContentMarkup", function() { return getContentMarkup; });
/* harmony import */ var _trip_event_form_trip_event_form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../trip-event-form/trip-event-form */ "./src/view/trip-event-form/trip-event-form.js");
/* harmony import */ var _trip_event_item_trip_event_item__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../trip-event-item/trip-event-item */ "./src/view/trip-event-item/trip-event-item.js");



const getContentMarkup = (tripEvents) => {
  const [tripEventEdited, ...restTripEvents] = tripEvents;
  return `<ul class="trip-events__list">
            ${Object(_trip_event_form_trip_event_form__WEBPACK_IMPORTED_MODULE_0__["getTripEventForm"])(tripEventEdited)}
            ${restTripEvents.map((tripEvent) => Object(_trip_event_item_trip_event_item__WEBPACK_IMPORTED_MODULE_1__["getTripEventItemMarkup"])(tripEvent)).join(``)}
    </ul>`;
};
...
/*!************************************!*\
  !*** ./src/view/layout/filters.js ***!
  \************************************/
/*! exports provided: getFiltersMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFiltersMarkup", function() { return getFiltersMarkup; });
...
/*!*********************************!*\
  !*** ./src/view/layout/menu.js ***!
  \*********************************/
/*! exports provided: getMenuMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMenuMarkup", function() { return getMenuMarkup; });
const getMenuMarkup = () => {
...
/*!**************************************!*\
  !*** ./src/view/layout/trip-info.js ***!
  \**************************************/
/*! exports provided: getTripInfoMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTripInfoMarkup", function() { return getTripInfoMarkup; });
const getTripInfoMarkup = ({route, price, startDate, endDate}) => {
...
/***/ "./src/view/trip-event-form/trip-event-destination-group.js":
/*!******************************************************************!*\
  !*** ./src/view/trip-event-form/trip-event-destination-group.js ***!
  \******************************************************************/
/*! exports provided: getTripEventDestinationGroupMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTripEventDestinationGroupMarkup", function() { return getTripEventDestinationGroupMarkup; });
const getTripEventDestinationGroupMarkup = ({type, destination}) => `
...
/***/ "./src/view/trip-event-form/trip-event-details/offer-item.js":
/*!*******************************************************************!*\
  !*** ./src/view/trip-event-form/trip-event-details/offer-item.js ***!
  \*******************************************************************/
/*! exports provided: getOfferItemMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getOfferItemMarkup", function() { return getOfferItemMarkup; });
const getOfferItemMarkup = ({
...
/*!***************************************************************************!*\
  !*** ./src/view/trip-event-form/trip-event-details/trip-event-details.js ***!
  \***************************************************************************/
/*! exports provided: getTripEventDetailsMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTripEventDetailsMarkup", function() { return getTripEventDetailsMarkup; });
/* harmony import */ var _offer_item__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./offer-item */ "./src/view/trip-event-form/trip-event-details/offer-item.js");


const getTripEventDetailsMarkup = ({description, photos, offers}) => {
  return `      <section class="event__details">
                  <section class="event__section  event__section--offers">
                    <h3 class="event__section-title  event__section-title--offers">Offers</h3>

                    <div class="event__available-offers">
                      ${offers.map((offer) => Object(_offer_item__WEBPACK_IMPORTED_MODULE_0__["getOfferItemMarkup"])(offer)).join(``)}
                    </div>
                  </section>
...
/***/ "./src/view/trip-event-form/trip-event-form.js":
/*!*****************************************************!*\
  !*** ./src/view/trip-event-form/trip-event-form.js ***!
  \*****************************************************/
/*! exports provided: getTripEventForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTripEventForm", function() { return getTripEventForm; });
/* harmony import */ var _trip_event_type_group__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./trip-event-type-group */ "./src/view/trip-event-form/trip-event-type-group.js");
/* harmony import */ var _trip_event_destination_group__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./trip-event-destination-group */ "./src/view/trip-event-form/trip-event-destination-group.js");
/* harmony import */ var _trip_event_time_group__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./trip-event-time-group */ "./src/view/trip-event-form/trip-event-time-group.js");
/* harmony import */ var _trip_event_price_field_group__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./trip-event-price-field-group */ "./src/view/trip-event-form/trip-event-price-field-group.js");
/* harmony import */ var _trip_event_details_trip_event_details__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./trip-event-details/trip-event-details */ "./src/view/trip-event-form/trip-event-details/trip-event-details.js");
  ...
  return `<li class="trip-events__item">
            <form class="event event--edit" action="#" method="post">
              <header class="event__header">
                ...
                ${Object(_trip_event_type_group__WEBPACK_IMPORTED_MODULE_0__["getTripEventTypeGroupMarkup"])({type})}

                ${Object(_trip_event_destination_group__WEBPACK_IMPORTED_MODULE_1__["getTripEventDestinationGroupMarkup"])({type, destination})}

                ${Object(_trip_event_time_group__WEBPACK_IMPORTED_MODULE_2__["getTripEventTimeGroupMarkup"])({startDate, endDate})}

                ${Object(_trip_event_price_field_group__WEBPACK_IMPORTED_MODULE_3__["getTripEventPriceFieldGroupMarkup"])({price})}
              ...
              ${Object(_trip_event_details_trip_event_details__WEBPACK_IMPORTED_MODULE_4__["getTripEventDetailsMarkup"])({description, photos, offers})}
...
/***/ "./src/view/trip-event-form/trip-event-price-field-group.js":
/*!******************************************************************!*\
  !*** ./src/view/trip-event-form/trip-event-price-field-group.js ***!
  \******************************************************************/
/*! exports provided: getTripEventPriceFieldGroupMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTripEventPriceFieldGroupMarkup", function() { return getTripEventPriceFieldGroupMarkup; });
const getTripEventPriceFieldGroupMarkup = ({price}) => `
...
/***/ "./src/view/trip-event-form/trip-event-time-group.js":
/*!***********************************************************!*\
  !*** ./src/view/trip-event-form/trip-event-time-group.js ***!
  \***********************************************************/
/*! exports provided: getTripEventTimeGroupMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTripEventTimeGroupMarkup", function() { return getTripEventTimeGroupMarkup; });
const getTripEventTimeGroupMarkup = ({startDate, endDate}) => `
...
/***/ "./src/view/trip-event-form/trip-event-type-group.js":
/*!***********************************************************!*\
  !*** ./src/view/trip-event-form/trip-event-type-group.js ***!
  \***********************************************************/
/*! exports provided: getTripEventTypeGroupMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTripEventTypeGroupMarkup", function() { return getTripEventTypeGroupMarkup; });
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../const */ "./src/const.js");


const getTripEventTypeGroupMarkup = ({type}) => {
...
/***/ "./src/view/trip-event-item/event-price.js":
/*!*************************************************!*\
  !*** ./src/view/trip-event-item/event-price.js ***!
  \*************************************************/
/*! exports provided: getEventPriceMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getEventPriceMarkup", function() { return getEventPriceMarkup; });
const getEventPriceMarkup = ({price}) => `
...
/*!****************************************************!*\
  !*** ./src/view/trip-event-item/event-schedule.js ***!
  \****************************************************/
/*! exports provided: getEventScheduleMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getEventScheduleMarkup", function() { return getEventScheduleMarkup; });
const getTimeDifference = (minutes) => {
  return `${Math.floor(minutes / 60)}H ${minutes % 60}M`;
};

const getEventScheduleMarkup = ({startDate, endDate}) => `
...
/*!*************************************************!*\
  !*** ./src/view/trip-event-item/offers-list.js ***!
  \*************************************************/
/*! exports provided: getOffersListMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getOffersListMarkup", function() { return getOffersListMarkup; });
const getOffersListMarkup = (offers) => `
...
/***/ "./src/view/trip-event-item/trip-event-item.js":
/*!*****************************************************!*\
  !*** ./src/view/trip-event-item/trip-event-item.js ***!
  \*****************************************************/
/*! exports provided: getTripEventItemMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTripEventItemMarkup", function() { return getTripEventItemMarkup; });
/* harmony import */ var _offers_list__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./offers-list */ "./src/view/trip-event-item/offers-list.js");
/* harmony import */ var _event_schedule__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./event-schedule */ "./src/view/trip-event-item/event-schedule.js");
/* harmony import */ var _event_price__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./event-price */ "./src/view/trip-event-item/event-price.js");




const getTripEventItemMarkup = ({
  ...
  return `<li class="trip-events__item">
              <div class="event">
                ...
                ${Object(_event_schedule__WEBPACK_IMPORTED_MODULE_1__["getEventScheduleMarkup"])({startDate, endDate})}

                ${Object(_event_price__WEBPACK_IMPORTED_MODULE_2__["getEventPriceMarkup"])({price})}

                <h4 class="visually-hidden">Offers:</h4>
                ${Object(_offers_list__WEBPACK_IMPORTED_MODULE_0__["getOffersListMarkup"])(offers)}
