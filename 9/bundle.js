...
class EventsItemPresenter extends _abstract_presenter__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  _notifySubscribers(action) {
    for (let subscriber of this._subscribers) {
      subscriber.notifyOnEventItemChange({data: this._data, mode: this._mode}, action);
    }
  }

  _setItemView(data) {
    const oldView = this._view;
    const newView = new _views_trip_event_item_event_item_view__WEBPACK_IMPORTED_MODULE_2__["default"](data);
  ...
  _setFormView(data) {
    const oldView = this._view;
    const newView = new _views_trip_event_form_form_view__WEBPACK_IMPORTED_MODULE_3__["default"](data);
    ...
    this._view = newView;
    this._view.setOnEventRollupButtonClickHandler(this._submitForm);
    this._view.setOnResetHandler(this._setDefaultMode);
    this._view.setOnSubmitHandler(this._submitForm);
  }
  ...
  _setEditingMode() {
    ...
    this._setFormView(this._data);
    this._notifySubscribers(EmittingActions.MODE_UPDATE);
  }

  _setDefaultMode() {
    this._mode = Modes.DEFAULT;
    this._setItemView(this._data);
    this._notifySubscribers(EmittingActions.MODE_UPDATE);
  }

  _setIsFavourite() {
    const newEvent = Object.assign({}, this._data);
    newEvent.isFavourite = this.data.isFavourite;
    this.data = newEvent;
...
class EventsListPresenter extends _abstract_presenter__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor({container}) {
    ...
    this.notifyOnEventItemChange = this.notifyOnEventItemChange.bind(this);
  }

  init(data) {
    this._data = data;
    this._view = new _views_layout_views_events_list_view__WEBPACK_IMPORTED_MODULE_4__["default"](data);
    ...
    for (let dataItem of data) {
      ...
      eventItemPresenter.init(dataItem);
      eventItemPresenter.subscribe(this);
      this._eventItemPresenters.set(dataItem, eventItemPresenter);
    }
  ...
  notifyOnEventItemChange({data: newEvent, mode}, action) {
    switch (action) {
      ...
      case _event_item_presenter__WEBPACK_IMPORTED_MODULE_3__["EmittingActions"].EVENT_UPDATE:
        ...
        const oldEvent = this._data.find((event) => {
          console.log({event, newEvent});
          return event.id === newEvent.id;
        });
        Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["replaceItemInArray"])(this._data, oldEvent, newEvent);

        const eventItemPresenter = this._eventItemPresenters.get(oldEvent);
        eventItemPresenter.updateData(newEvent);
...
/* harmony import */ var _sort_presenter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sort-presenter */ "./src/presenters/sort-presenter.js");
/* harmony import */ var _trip_info_presenter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./trip-info-presenter */ "./src/presenters/trip-info-presenter.js");
/* harmony import */ var _menu_presenter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./menu-presenter */ "./src/presenters/menu-presenter.js");
/* harmony import */ var _filter_presenter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./filter-presenter */ "./src/presenters/filter-presenter.js");
...
class LayoutPresenter {
  ...
  init() {
    ...
    this._sortMode = _sort_presenter__WEBPACK_IMPORTED_MODULE_2__["SortModes"].DAY;

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["clearInnerHTML"])(this._containers.TRIP_EVENTS, this._containers.MENU);

    const tripInfoPresenter = new _trip_info_presenter__WEBPACK_IMPORTED_MODULE_3__["default"]({container: this._containers.TRIP_MAIN});
    tripInfoPresenter.init(trip);
    this._layoutItemPresenters.set(Layout.TRIP_INFO, tripInfoPresenter);

    const menuPresenter = new _menu_presenter__WEBPACK_IMPORTED_MODULE_4__["default"]({container: this._containers.MENU});
    menuPresenter.init();
    this._layoutItemPresenters.set(Layout.MENU, menuPresenter);

    const filtersPresenter = new _filter_presenter__WEBPACK_IMPORTED_MODULE_5__["default"]({container: this._containers.MENU});
    filtersPresenter.init();
    this._layoutItemPresenters.set(Layout.FILTERS, filtersPresenter);

    const sortPresenter = new _sort_presenter__WEBPACK_IMPORTED_MODULE_2__["default"]({container: this._containers.TRIP_EVENTS});
    sortPresenter.init();
    sortPresenter.subscribe(this);
...
/*!******************************************!*\
  !*** ./src/presenters/sort-presenter.js ***!
  \******************************************/
/*! exports provided: SortModes, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SortModes", function() { return SortModes; });
...
class SortPresenter extends _abstract_presenter__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  setSortMode(sortMode) {
    if (this._sortMode === sortMode || !Object.values(SortModes).includes(sortMode)) {
      return;
    }
    this._sortMode = sortMode;
  ...
  _notifySubscribers() {
    for (let subscriber of this._subscribers) {
      subscriber.notifyOnSortChange({sortMode: this._sortMode});
    }
  }
...
class TripInfoPresenter extends _abstract_presenter__WEBPACK_IMPORTED_MODULE_1__["default"] {
  init(data) {
    this._view = new _views_layout_views_trip_info_view__WEBPACK_IMPORTED_MODULE_2__["default"](data);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._container, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN, this._view);
  }
}
...
class AbstractView {
  constructor(data) {
    if (new.target === AbstractView) {
      throw new Error(
          `AbstractView should be extended and cannot be instantiated`
      );
    }
    this._element = null;
    this._data = data;
...
class EventsListView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(data) {
    ...
    this.setOnEscKeydownHandler = this.setOnEscKeydownHandler.bind(this);
    this.setReplaceItemWithForm = this.setReplaceItemWithForm.bind(this);
  }
...
class SortView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this.setOnChangeHandler = this.setOnChangeHandler.bind(this);
  }
  ...
  setOnChangeHandler(setSortMode) {
    const onChangeHandler = (evt) => {
      setSortMode(evt.target.value);
    };
    this._callbacks.onChangeHandler = onChangeHandler;
    this.getElement().addEventListener(`change`, onChangeHandler);
  }
}
...
class TripInfoView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    const {route, price, startDate, endDate} = this._data;
...
class SmartView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(data) {
    ...
    if (new.target === SmartView) {
      throw new Error(
          `SmartView should be extended and cannot be instantiated`
      );
    }
  }

  update(updateData, rerender = true) {
    if (!updateData) {
      return;
    }

    this._data = Object.assign({}, this._data, updateData);
  ...
  restoreHandlers() {
    throw new Error(
        `Abstract method restoreHandlers not implemented`
    );
  }
}
...
/* harmony import */ var _smart_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../smart-view */ "./src/views/smart-view.js");





const getTripEventTypeGroupTemplate = (type) => {
...
const getTripEventDestinationGroupTemplate = (type, destination) => {
...
const getTripEventTimeGroupTemplate = (startDate, endDate) => {
...
const getTripEventPriceFieldGroupTemplate = (price) => {
...
const getOfferTemplate = (offer) => {
  const {name, title, price, isSelected} = offer;
...
const getTripEventDetailsTemplate = (description, photos, offers) => {
...
class TripEventFormView extends _smart_view__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(data) {
    super(data);

    this.setOnSubmitHandler = this.setOnSubmitHandler.bind(this);
    this.setOnResetHandler = this.setOnResetHandler.bind(this);
    this.setOnEventRollupButtonClickHandler = this.setOnEventRollupButtonClickHandler.bind(this);
  ...
  _onEventTypeChange(evt) {
    this.update({type: evt.target.value});
  }


  getTemplate() {
    const {type, destination, price, description, photos, startDate, endDate, offers} = this._data;
    return `<li class="trip-events__item">
             <form class="event event--edit" action="#" method="post">
               <header class="event__header">
                 ${getTripEventTypeGroupTemplate(type)}
                 ${getTripEventDestinationGroupTemplate(type, destination)}
                 ${getTripEventTimeGroupTemplate(startDate, endDate)}
                 ${getTripEventPriceFieldGroupTemplate(price)}
               ...
               ${getTripEventDetailsTemplate(description, photos, offers)}
             </form>
           </li>`;
  }
  ...
  restoreHandlers() {
    this._setInternalHandlers();
    this.setOnSubmitHandler(this._callbacks.submitHandler);
    this.setOnResetHandler(this._callbacks.resetHandler);
    this.setOnEventRollupButtonClickHandler(this._callbacks.onEventRollupButtonClickHandler);
  }
...
class AddToFavouritesButtonView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    const {isFavouriteClassName} = this._data;
...
class TripEventItemView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(data) {
    ...
    this.setOnFavouriteButtonClickHandler = this.setOnFavouriteButtonClickHandler.bind(this);
    this.setOnRollupButtonClickHandler = this.setOnRollupButtonClickHandler.bind(this);
  }

  getTemplate() {
    const {type, destination, price, startDate, endDate, offers, isFavourite} = this._data;
  ...
  setOnRollupButtonClickHandler(cb) {
    this._callbacks.onRollupButtonClickHandler = () => cb(this._data);
    this.getElement().querySelector(`.event__rollup-btn`).addEventListener(`click`, this._callbacks.onRollupButtonClickHandler);
  }
...
class EventScheduleView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    const {startDate, endDate} = this._data;
